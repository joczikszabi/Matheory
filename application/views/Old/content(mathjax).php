...
<body>
...
</div><a class="hidden-xs link-help" href="#">Help </a></div>
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 hidden-xs hidden-sm menu"></div>
    ...
    <script src="<?php echo base_url('assets/js/mathjax.js') ?>"></script>
